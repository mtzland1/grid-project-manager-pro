...
const RolePermissionManager = ({ project }: RolePermissionManagerProps) => {
  ...
  const createDefaultColumns = async () => {
    const defaultColumns = [
      { column_key: 'descricao', column_label: 'DESCRIÇÃO', column_type: 'text', column_width: '150px', column_order: 1, is_system_column: true },
      ...
      { column_key: 'cc_mat_uni', column_label: 'CC MAT UNI (R$)', column_type: 'currency', column_width: '120px', column_order: 6, is_system_column: true },
      { column_key: 'cc_mat_total', column_label: 'CC MAT TOTAL (R$)', column_type: 'currency', column_width: '130px', column_order: 7, is_system_column: true },
      { column_key: 'ipi', column_label: 'IPI (R$)', column_type: 'currency', column_width: '90px', column_order: 8, is_system_column: true },
      { column_key: 'distribuidor', column_label: 'DISTRIBUIDOR', column_type: 'text', column_width: '120px', column_order: 9, is_system_column: true },
      { column_key: 'vlr_total_estimado', column_label: 'VLR. TOTAL ESTIMADO', column_type: 'currency', column_width: '150px', column_order: 10, is_system_column: true, is_calculated: true },
      { column_key: 'vlr_total_venda', column_label: 'VLR. TOTAL VENDA', column_type: 'currency', column_width: '150px', column_order: 11, is_system_column: true, is_calculated: true },
      { column_key: 'reanalise_escopo', column_label: 'Reanalise Escopo', column_type: 'text', column_width: '130px', column_order: 12, is_system_column: true },
      { column_key: 'prioridade_compra', column_label: 'Prioridade Compra', column_type: 'text', column_width: '130px', column_order: 13, is_system_column: true },
      { column_key: 'reanalise_mo', column_label: 'Reanalise MO', column_type: 'text', column_width: '120px', column_order: 14, is_system_column: true },
      { column_key: 'conferencia_estoque', column_label: 'Conferencia Estoque', column_type: 'text', column_width: '140px', column_order: 15, is_system_column: true },
      { column_key: 'a_comprar', column_label: 'A Comprar', column_type: 'text', column_width: '100px', column_order: 16, is_system_column: true },
      { column_key: 'comprado', column_label: 'Comprado', column_type: 'text', column_width: '100px', column_order: 17, is_system_column: true },
      { column_key: 'previsao_chegada', column_label: 'Previsão de Chegada', column_type: 'date', column_width: '140px', column_order: 18, is_system_column: true },
      { column_key: 'expedicao', column_label: 'Expedição', column_type: 'text', column_width: '100px', column_order: 19, is_system_column: true },
      { column_key: 'cronograma_inicio', column_label: 'Cronograma Inicio', column_type: 'date', column_width: '140px', column_order: 20, is_system_column: true },
      { column_key: 'data_medicoes', column_label: 'Data Medições', column_type: 'date', column_width: '120px', column_order: 21, is_system_column: true },
      { column_key: 'data_conclusao', column_label: 'Data Conclusão', column_type: 'date', column_width: '120px', column_order: 22, is_system_column: true },
      { column_key: 'manutencao', column_label: 'Manutenção', column_type: 'text', column_width: '100px', column_order: 23, is_system_column: true },
      { column_key: 'status_global', column_label: 'Status Global', column_type: 'text', column_width: '120px', column_order: 24, is_system_column: true },
      { column_key: 'suma', column_label: 'SUMA', column_type: 'currency', column_width: '120px', column_order: 25, is_system_column: true },
    ];
